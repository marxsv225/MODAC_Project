			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Ajout d'une sous catégorie</h2>
...
<option value="" selected disabled> Selectionnez la catégorie </option>
...
<div class="col-sm-4">
<input type="text" name="nomprod" class="form-control white_bg" required>
</div>
</div><br><br><br>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit" style="margin-bottom: 150px;">Enregistrer</button>
												</div>
											</div>
