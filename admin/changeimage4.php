						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Détails de l'image 4</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Image actuelle</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Charger une nouvelle image<span style="color:red">*</span></label>
												<div class="col-sm-8">
